...
export default function MonthlyProgramsEdit() {
  ...
  const handleProgramChange = (e, id) => {
    ...
    setSectionContent((prev) => ({
      ...prev,
      monthlyPrograms: prev.monthlyPrograms.map((program) =>
  ...
  const handleAddProgram = () => {
    const newProgram = {
      id: Math.max(0, ...sectionContent.monthlyPrograms.map((p) => p.id)) + 1,
      title: "",
      description: "",
      location: "Parish House Indy",
      day: "",
    ...
    setSectionContent((prev) => ({
      ...prev,
      monthlyPrograms: [...prev.monthlyPrograms, newProgram],
    }));
  ...
  const handleDeleteProgram = (id) => {
    setSectionContent((prev) => ({
      ...prev,
      monthlyPrograms: prev.monthlyPrograms.filter(
  ...
  return (
    <div className="mb-12 border border-gray-200 rounded-lg overflow-hidden">
      <div className="p-4 border-b border-gray-200 bg-gray-50 flex justify-between items-center">
        <h3 className="font-medium text-gray-800">Monthly Programs Section</h3>
        <button
          onClick={() => {
        ...
        <div className="p-8 bg-white">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {sectionContent.monthlyPrograms.map((program) => (
                <div
                  key={program.id}
