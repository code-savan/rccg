...
export function mapWeeklyProgramsSectionToDB(sectionContent) {
  return {
    ...
    weekly_programs: JSON.stringify(sectionContent.weeklyPrograms),
  };
}
...
export function mapDBToWeeklyProgramsSection(dbData) {
  return {
    ...
    weeklyPrograms: JSON.parse(dbData.weekly_programs),
  };
}
...
export function mapMonthlyProgramsSectionToDB(sectionContent) {
  return {
    ...
    monthly_programs: JSON.stringify(sectionContent.monthlyPrograms),
  };
}
...
export function mapDBToMonthlyProgramsSection(dbData) {
  return {
    ...
    monthlyPrograms: JSON.parse(dbData.monthly_programs),
  };
}
...
export function mapUpcomingEventsSectionToDB(sectionContent) {
  return {
    ...
    upcoming_events: JSON.stringify(sectionContent.events),
  };
}
...
export function mapDBToUpcomingEventsSection(dbData) {
  return {
    ...
    events: JSON.parse(dbData.upcoming_events),
  };
}
